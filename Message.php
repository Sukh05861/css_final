     ...
     <!-- main tag--> 
       ...
       <?php
	        ...
	        $emailAddress = $_GET['emailAddress'];
	         ...
	         echo('<p>Congratulations '.$emailAddress.', You have successfully login to the Onlinemobiles.com.<br/><br/>THANK YOU!!!!<br/> 
           <br/>HAVE A NICE DAY!!!</p>');
       ?>  
   </div>
      <div class="js">
      <button id= "mybtn" onclick="myFunction()">Check here to buy Smartphones.</button>
      </div>
      <script>
        function myFunction() {
